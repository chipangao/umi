export default {
  ...
  'menu.people1-list': 'People1 list',
  'menu.peple-list': 'People-list',
  'menu.aa-list': 'menu.aa-list',
  'menu.33-list': 'menu.33-list',
  'menu.user1-list': 'menu.user1-list',
  'menu.user-list': 'menu.user-list',
  'menu.animal-list': 'menu.animal-list',
  'menu.username-list': 'menu.username-list',
  'menu.daysummary-list': 'menu.daysummary-list',
  'menu.people1-list.edit': 'menu.people1-list.edit',
  'menu.people1-list.add': 'menu.people1-list.add',
